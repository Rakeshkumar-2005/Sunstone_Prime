...
//  then Harshit purchases 2 smartphones, then Aayush purchases 3 smartphones, then Harshit purchases 4 smartphones, and so on.
...
// Test case 2. Now we have M = 8 and N = 11. Aayush shops for 1 smartphone first, and then Harshit shops for 2 smartphones, then Aayush shops for 3 smartphones. 
...
// Purchases increase like:
// 1, 2, 3, 4, 5, 6 ...

// Turns:

// Turn	Person	Smartphones
// 1	Aayush	1
// 2	Harshit	2
// 3	Aayush	3
// 4	Harshit	4
...
// Aayush total phones ≤ M

// Harshit total phones ≤ N

// Agar koi apni turn par required phones nahi kharid paata → wo lose karega
...
// If i is odd → Aayush turn

// If i is even → Harshit turn

// Check:

// if aayushSum + i > M → Harshit wins
// if harshitSum + i > N → Aayush wins
